        ...
        <form action="{{ route('peliculas.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="clave_pelicula" id="clave_pelicula" value="{{ old('clave_pelicula') }}" required>
                    @error('clave_pelicula') <span class="error">{{ $message }}</span> @enderror
                </div>
                
                <div class="form-group">
                    <label for="anio">Año *</label>
                    <input type="number" name="anio" id="anio" value="{{ old('anio') }}" min="1900" max="{{ date('Y') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="titulo_original" id="titulo_original" value="{{ old('titulo_original') }}">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="duracion_min" id="duracion_min" value="{{ old('duracion_min') }}" min="1">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="calificacion" id="calificacion" value="{{ old('calificacion') }}" min="0" max="10" step="0.1">
                    @error('calificacion') <span class="error">{{ $message }}</span> @enderror
                </div>
                
                <div class="form-group">
                    <label for="fecha_estreno">Fecha de Estreno</label>
                    <input type="date" name="fecha_estreno" id="fecha_estreno" value="{{ old('fecha_estreno') }}">
            ...
            <div class="form-group">
                ...
                <textarea name="sinopsis" id="sinopsis" rows="4" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">{{ old('sinopsis') }}</textarea>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="presupuesto" id="presupuesto" value="{{ old('presupuesto') }}" min="0" step="0.01">
                    @error('presupuesto') <span class="error">{{ $message }}</span> @enderror
                </div>
                
                <div class="form-group">
                    <label for="recaudacion">Recaudación</label>
                    <input type="number" name="recaudacion" id="recaudacion" value="{{ old('recaudacion') }}" min="0" step="0.01">
